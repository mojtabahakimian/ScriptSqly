...
";
            ...
            // --- 36-tagcod-tartib-seed.sql ---
            // پيش از دروازه، چون CHK-01/CHK-02 همين ستون را مي‌خوانند.
            string tagcodTartib = @"
/* ═══════════════════════════════════════════════════════════════════
...
GO
";
            TryExecuteCostCloseBatch(db, tagcodTartib,
                "TAGCOD.tartib",
                "اين اسکريپت به جدول پايه‌ي dbo.TAGCOD نياز دارد.");
...
";
            ...
            // --- 29-margin-by-produnit.sql ---
            string marginByProdUnit = @"
/* ═══════════════════════════════════════════════════════════════════
...
GO
";
            TryExecuteCostCloseBatch(db, marginByProdUnit,
                "CC_ItemMarginProdUnit و CC_sp_S12p_MarginByProdUnit",
                "اسکريپت 29-margin-by-produnit.sql را اجرا کنيد (به CC_ItemMargin و CC_UnitAnbar نياز دارد).");
...
GO
";
            TryExecuteCostCloseBatch(db, aiAssistant,
                "AI_UserAccess و AI_ChatLog",
                "اسکريپت 30-ai-assistant.sql را اجرا کنيد (دسترسي و لاگ دستيار هوش مصنوعي).");
...
GO
";
            TryExecuteCostCloseBatch(db, aiConfig,
                "AI_Config",
                "اسکريپت 31-ai-config.sql را اجرا کنيد (تنظيمات سرويس هوش مصنوعي).");

            // --- 32-ai-conversation.sql ---
